...
import { Component, EventEmitter, HostListener, Input, NgModule, Output, ViewChild } from '@angular/core';
...
class WalkthroughComponent {
     ...
     * @return {?}
     */
    set focusElementSelector(focusElementSelector) {
     ...
     */
    ngAfterViewChecked() {
        let /** @type {?} */ translude = this.element.nativeElement.querySelectorAll('.' + this.DOM_TRANSCLUDE);
    ...
    setArrowAndText(pointSubjectLeft, pointSubjectTop, pointSubjectWidth, pointSubjectHeight, paddingLeft) {
        let /** @type {?} */ offsetCoordinates = this.getOffsetCoordinates(this.walkthroughTextElement);
        let /** @type {?} */ startLeft = offsetCoordinates.left + offsetCoordinates.width / 2;
        let /** @type {?} */ startTop = offsetCoordinates.top + offsetCoordinates.height + this.PADDING_ARROW_START;
        let /** @type {?} */ endLeft = 0;
        ...
        let /** @type {?} */ arrowLeft, /** @type {?} */ arrowRight, /** @type {?} */ arrowTop, /** @type {?} */ arrowBottom;
        ...
        let /** @type {?} */ arrowElement = this.element.nativeElement.querySelector(this.DOM_WALKTHROUGH_ARROW_CLASS);
    ...
    isItemOnText(iconLeft, iconTop, iconRight, iconBottom) {
        let /** @type {?} */ holeCoordinates = this.getOffsetCoordinates(this.walkthroughHoleElements);
        let /** @type {?} */ offsetCoordinates = this.getOffsetCoordinates(this.walkthroughTextElement);
        let /** @type {?} */ holeLeft = holeCoordinates.left;
        let /** @type {?} */ holeRight = holeCoordinates.left + holeCoordinates.width;
        let /** @type {?} */ holeTop = holeCoordinates.top;
        let /** @type {?} */ holeBottom = holeCoordinates.top + holeCoordinates.height;
        let /** @type {?} */ textLeft = document.body.clientWidth / 4; //needs to be calculated differently due to being a 'pre'. //offsetCoordinates.left;
        let /** @type {?} */ textRight = document.body.clientWidth / 4 * 3; //offsetCoordinates.left + offsetCoordinates.width;
        let /** @type {?} */ textTop = offsetCoordinates.top;
        let /** @type {?} */ textBottom = offsetCoordinates.top + offsetCoordinates.height;
    ...
    getOffsetCoordinates(focusElement) {
        ...
        let /** @type {?} */ sameAncestorForFocusElementAndWalkthrough = this.getSameAncestor(focusElement);
...
/** @nocollapse */
WalkthroughModule.ctorParameters = () => [];
...
export { WalkthroughModule, WalkthroughComponent as ɵa };
